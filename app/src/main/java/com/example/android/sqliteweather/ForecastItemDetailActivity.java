...
public class ForecastItemDetailActivity extends AppCompatActivity {
    public static final String EXTRA_FORECAST_ITEM = "ForecastLocation";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null && intent.hasExtra(EXTRA_FORECAST_ITEM)) {
            mForecastItem = (ForecastItem)intent.getSerializableExtra(EXTRA_FORECAST_ITEM);
        ...
        final ImageView locationBookmarkIV = findViewById(R.id.rv_saved_location);
        locationBookmarkIV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mForecastItem != null) {
                    if (!mIsSaved) {
                        mViewModel.insertSavedLocation(mForecastItem);
                    } else {
                        mViewModel.deleteSavedLocation(mForecastItem);
                    }
                }
            }
        });
